  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Simplifying your dining experience. Reserve your table, while we manage reservations and menus effortlessly."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Simplifying your dining experience. Reserve your table, while we manage reservations and menus effortlessly.`}
            </Text>
            <Box
